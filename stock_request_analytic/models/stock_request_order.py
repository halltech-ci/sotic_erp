...
class StockRequestOrder(models.Model):
    ...
    analytic_account_ids = fields.One2many("account.analytic.account", compute="_compute_analytic_ids", string="Analytic Accounts", readonly=True,)
    analytic_tag_ids = fields.One2many("account.analytic.tag", compute="_compute_analytic_ids", string="Analytic Tags", readonly=True,)
    default_analytic_account_id = fields.Many2one("account.analytic.account", string="Default Analytic Account", help="Set this if you want to define a default analytic account on requests",)
