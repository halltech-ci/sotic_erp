...
class ResCompany(models.Model):
    ...
    attendance_sheet_range = fields.Selection(
        ...
        string="Attendance Sheet Range", default="WEEKLY", help="The range of your Attendance Sheet.",    )
    date_start = fields.Date(string="Date From", index=True, default=datetime.today().date())
